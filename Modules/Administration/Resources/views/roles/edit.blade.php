...
@section('title', 'Edit Role - Module Administration')
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.roles.update", ['id' =>  $role->id]) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="{{ $role->description }}">
                </div>
